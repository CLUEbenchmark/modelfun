...
def transform_custom(example, label_normalize_dict=None, label_length=None, is_test=False):
    if is_test:
        ...
        # example['label_desc'] = label_normalize_dict[origin_label]
        example["sentence1"] = example["sentence1"]
        example["text_label"] = label_normalize_dict[example['label']]#example["label_desc"]
        # del example["sentence"]
        # del example["label_desc"]
        # print(example)
        return example
