...
from paddlenlp.transformers.roberta.modeling import RobertaPretrainedModel, RobertaLMHead
...
class RobertaPretrainingHeads(Layer):
    def __init__(self,
                 hidden_size,
                 vocab_size,
                 activation,
        ...
        self.predictions = RobertaLMHead(hidden_size, vocab_size,
