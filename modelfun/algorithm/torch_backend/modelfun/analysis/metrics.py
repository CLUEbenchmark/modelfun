...
from modelfun.utils.core import filter_labels, to_int_label_array
...
METRICS = {
    ...
    "precision_macro": Metric(_precision_macro_score, ["golds", "probs"]),
    "recall_macro": Metric(_recall_macro_score, ["golds", "probs"]),
}
